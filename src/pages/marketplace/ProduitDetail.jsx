...
import { 
  ...
  MapPin, ShoppingCart, Info, AlertTriangle, Check, Layers, ArrowLeft
} from 'lucide-react';
import { mockProducts, mockShops } from '../../data/mockData';
...
export default function ProduitDetail({ productId = 101, onBack }) {
  ...
  return (
    <motion.div 
      ...
      className="fixed inset-0 z-50 mx-auto overflow-y-auto bg-white shadow-xl border-x border-slate-100"
    >
      {/* Bouton retour en haut à gauche */}
      <button onClick={onBack} className="flex items-center gap-2 p-4 text-slate-800">
        <ArrowLeft className="w-5 h-5" /> Fiche produit
      </button>
